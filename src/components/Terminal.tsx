...
export const commands: Command = [
  { cmd: "about", desc: "about Idot", tab: 8 },
  { cmd: "clear", desc: "clear the terminal", tab: 8 },
  { cmd: "echo", desc: "print out anything", tab: 9 },
  { cmd: "education", desc: "education your mom", tab: 4 },
  { cmd: "email", desc: "send an email to me, idk why", tab: 8 },
  { cmd: "gui", desc: "go to a cool website", tab: 10 },
  { cmd: "help", desc: "check available commands", tab: 9 },
  { cmd: "history", desc: "view command history", tab: 6 },
  { cmd: "projects", desc: "this is common sense", tab: 5 },
  { cmd: "pwd", desc: "print current working directory", tab: 10 },
  { cmd: "socials", desc: "socials i exist at", tab: 6 },
